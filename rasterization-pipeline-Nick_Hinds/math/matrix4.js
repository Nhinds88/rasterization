...
var Matrix4 = function(x, y, z) {
  ...
  this.test_createEarthMatrix = function(currentRotationAngle, startingPosition) {
    var translation = new Matrix4().setTranslation(startingPosition);
    var rotation = new Matrix4().setRotationZ(currentRotationAngle);
    return rotation.clone().multiplyRightSide(translation);
  }

	// -------------------------------------------------------------------------
  this.test_createMoonMatrix = function(currentRotationAngle, offsetFromEarth, earthTransform) {
    var translation = new Matrix4().setTranslation(offsetFromEarth);
    var rotation = new Matrix4().setRotationZ(currentRotationAngle);
    var moonTransform = rotation.clone().multiplyRightSide(translation);
    return earthTransform.multiplyRightSide(moonTransform);
  }
